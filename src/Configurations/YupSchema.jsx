...
export const commentSchema = yup.object({
  comment: yup.string().trim().trim().required(" comment can not be an empty!"),
});
...
export const BlogSchema = yup.object({
  title: yup.string().trim().required("Title can not be an empty!"),
  sub_category_id: yup.number().required(" Sub Category can not be an empty!"),
  content: yup.string().required("Content can not be an empty!"),
});
